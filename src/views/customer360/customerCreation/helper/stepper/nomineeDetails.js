...
const nomineeDetailsStep = (props) => {
  const { customerDetails, handleNomineeValidationHandler } = props;
  ...
  return {
    ...
    input: [
      {
        ...
        multiSelect: false,
        defaultValue: customerDetails?.nominee_relationship || '',
      ...
      },
      {
        ...
        type: 'text',
        defaultValue: customerDetails?.nominee_other_relation || '',
      ...
      },
      {
        ...
        label: 'Nominee Name',
        type: 'text',
        defaultValue: customerDetails?.nominee_name || '',
        identifier: IDENTIFIER.INPUTTEXT,
        validation: {
          isRequired: true,
      ...
      },
      {
        ...
        type: 'date',
        defaultValue: customerDetails?.nominee_dob || '',
      ...
      },
      {
        ...
        type: 'text',
        defaultValue: customerDetails?.nominee_mobile || '',
        identifier: IDENTIFIER.INPUTTEXT,
        validation: {
          isRequired: true,
    ...
    dynamicValidation: handleNomineeValidationHandler,
    buttonDetails: {
      name: 'Next',
    },
    alignment: {
